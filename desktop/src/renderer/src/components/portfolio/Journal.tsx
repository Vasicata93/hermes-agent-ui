...
import { Pencil as PencilIcon, Trash2 as TrashIcon, Brain as BrainIcon, Check as CheckIcon, Smile as MoodExcellentIcon, SmilePlus as MoodGoodIcon, Meh as MoodNeutralIcon, Frown as MoodBadIcon, Angry as MoodTerribleIcon, X, Activity, Cpu, Zap, Globe } from 'lucide-react';
        ...
        <div className="space-y-8 pb-40">
            ...
            >
                {['journal', 'mindset'].map((tab) => (
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center py-2 rounded-lg text-[10px] font-black uppercase tracking-tight transition-all duration-200 ${activeTab === tab
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className={`lg:col-span-1 space-y-8 ${activeTab === 'mindset' ? 'block' : 'hidden lg:block'}`}>
                    ...
                    <Card className="p-6 bg-zinc-900/50 border-pplx-accent/20">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xs font-bold uppercase tracking-wider text-pplx-accent">Agent System Monitor</h3>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center text-xs">
                                <div className="flex items-center gap-2 text-zinc-400"><Cpu size={14} /> Model Active</div>
                                <div className="font-bold text-zinc-200">Claude 3.5 Sonnet</div>
                            </div>
                            <div className="flex justify-between items-center text-xs">
                                <div className="flex items-center gap-2 text-zinc-400"><Activity size={14} /> Latență</div>
                                <div className="font-bold text-zinc-200">124ms</div>
                            </div>
                            <div className="flex justify-between items-center text-xs">
                                <div className="flex items-center gap-2 text-zinc-400"><Zap size={14} /> Skill-uri Active</div>
                                <div className="font-bold text-pplx-accent">12 Active</div>
                            </div>
                            <div className="pt-4 border-t border-white/5">
                                <a
                                    href="https://hermes.agent/skillhub"
                                    target="_blank"
                                    className="flex items-center justify-center gap-2 w-full py-2.5 bg-zinc-100 dark:bg-zinc-100 text-zinc-900 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-white transition-all"
                                >
                                    <Globe size={14} /> Vizitează SkillHub
                                </a>
                            </div>
                        </div>
                    </Card>
